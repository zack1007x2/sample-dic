 ...
 */
public abstract class peng_AdapterView<T extends Adapter> extends ViewGroup {
    ...
    public peng_AdapterView(Context context) {
        super(context);
    }

    public peng_AdapterView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public peng_AdapterView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(peng_AdapterView<?> parent, View view, int position, long id);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         */
        boolean onItemLongClick(peng_AdapterView<?> parent, View view, int position, long id);
    }
    ...
    public interface OnItemSelectedListener {
         ...
         */
        void onItemSelected(peng_AdapterView<?> parent, View view, int position, long id);
         ...
         */
        void onNothingSelected(peng_AdapterView<?> parent);
    }
    ...
    class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (peng_AdapterView.this.getAdapter().hasStableIds() && mInstanceState != null && mOldItemCount == 0 && mItemCount > 0) {
                peng_AdapterView.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                rememberSyncState();
            }
        ...
        public void onInvalidated() {
            ...
            if (peng_AdapterView.this.getAdapter().hasStableIds()) {
                // Remember the current state for the case where our hosting
                // activity is being
                // stopped and later restarted
                mInstanceState = peng_AdapterView.this.onSaveInstanceState();
            }
