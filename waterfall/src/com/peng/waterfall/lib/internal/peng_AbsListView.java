...
public abstract class peng_AbsListView extends peng_AdapterView<ListAdapter> implements ViewTreeObserver.OnGlobalLayoutListener,
     ...
     * Acts upon click
     */
    private peng_AbsListView.PerformClick mPerformClick;
    ...
    public interface OnScrollListener {
         ...
         *            {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChanged(peng_AbsListView view, int scrollState);
         ...
         */
        public void onScroll(peng_AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount);
    }

    public peng_AbsListView(Context context) {
        super(context);
        initAbsListView();
    ...
    public peng_AbsListView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.absListViewStyle);
    }

    public peng_AbsListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public boolean showContextMenuForChild(View originalView) {
        ...
        if (longPressPosition >= 0) {
            ...
            if (mOnItemLongClickListener != null) {
                handled = mOnItemLongClickListener.onItemLongClick(peng_AbsListView.this, originalView, longPressPosition, longPressId);
            }
            if (!handled) {
        ...
        case MotionEvent.ACTION_UP: {
            ...
            case TOUCH_MODE_DONE_WAITING:
                ...
                if (child != null && !child.hasFocusable()) {
                    ...
                    final peng_AbsListView.PerformClick performClick = mPerformClick;
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new peng_AbsListView.LayoutParams(getContext(), attrs);
    }

    @Override
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof peng_AbsListView.LayoutParams;
    }
    ...
    public void reclaimViews(List<View> views) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            peng_AbsListView.LayoutParams lp = (peng_AbsListView.LayoutParams) child.getLayoutParams();
     ...
     *            recycler.
     * 
     * @see android.widget.peng_AbsListView.RecycleBin
    ...
    class RecycleBin {
        ...
        void addScrapView(View scrap) {
            peng_AbsListView.LayoutParams lp = (peng_AbsListView.LayoutParams) scrap.getLayoutParams();
            if (lp == null) {
                return;
            }
        ...
        void scrapActiveViews() {
            ...
            for (int i = count - 1; i >= 0; i--) {
                ...
                if (victim != null) {
                    int whichScrap = ((peng_AbsListView.LayoutParams) victim.getLayoutParams()).viewType;
